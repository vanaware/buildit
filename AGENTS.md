# Project Guidelines: BuildIt (Deno PWA)

Welcome to the BuildIt project! This file (`AGENTS.md`) is automatically injected into the AI's system instructions. You MUST strictly adhere to the following architectural rules and constraints when modifying or extending this codebase.
