...
import { db, opfs, version, } from "@vanaware/buildit";
import {
  activeTab,
  addLog,
  indexLog,
  ...
  return (
    <article class="border">
      ...
      <p>
        ...
        directly in the browser. BuildIt gives you a clean API to interact with
  ...
  return (
    <article class="border">
      ...
      <p>
        ...
        BuildIt leverages native IDB indexes for blazing fast aggregations,
...
const PaginationDemo = () => {
  ...
  return (
    <article class="border">
      ...
      <p>
        Loading thousands of records at once crashes the browser. BuildIt
...
const SWDemo = () => {
  ...
  return (
    <article class="border">
      ...
      <p>
        BuildIt doesn't just run on the main thread or Web Workers—it runs
    ...
    <main class="responsive">
      ...
      <footer class="center-align padding surface-container-highest">
        <p class="italic small-text">
          BuildIt v{version} — Powered by Deno & Preact
        </p>
      </footer>
    </main>
  );
