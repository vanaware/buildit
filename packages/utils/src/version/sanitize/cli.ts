...
export function sanitizeVersionCli(): Command<any, any, any, any, any, any, any, any> {
  return new Command()
    .name("sanitize-version")
    .description("Normaliza a versão do deno.json[c] para formato semver estrito (MAJOR.MINOR.PATCH)")
    .version(APP_VERSION)
