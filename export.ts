 ...
 * Contém as configurações específicas do projeto BuildIt e a lógica de execução.
 * A lógica pura reutilizável está em @vanaware/buildit/export.
 *
 * Comportamento:
...
import {
  ...
  gerarCabecalho,
} from "@vanaware/buildit/export";
import type { ExportConfig, } from "@vanaware/buildit/interfaces";
import { APP_VERSION, EXTENSOES_PADRAO, } from "@vanaware/buildit/config";
...
/**
 * Modos de exportação disponíveis no BuildIt.
...
/**
 * Dicionário de configurações para cada modo de exportação do BuildIt.
